...
namespace CollectionsRingBufferImplPushKVarSolutions
...
end CollectionsRingBufferImplPushKVarSolutions
                  ...
                  ((collections_sslice_len (t0 := Int) (CollectionsRingBufferRingBuffer.ring old₀)) ≥ 0) ->
                   ((collections_sslice_len (t0 := Int) (CollectionsRingBufferRingBuffer.ring old₀)) ≤ 18446744073709551615) ->
                    ...
                    (((collections_sslice_len (t0 := Int) (CollectionsRingBufferRingBuffer.ring old₀)) ≠ 0) ->
                     ...
                     (((k0 old₀ val₀ True (CollectionsRingBufferRingBuffer.ring old₀) (a'₂ % (collections_sslice_len (t0 := Int) (CollectionsRingBufferRingBuffer.ring old₀))) (CollectionsRingBufferRingBuffer.tl old₀) (CollectionsRingBufferRingBuffer.ring old₀) (CollectionsRingBufferRingBuffer.hd old₀) (CollectionsRingBufferRingBuffer.tl old₀) val₀))) ∧
                     (∀ (a'₃ : Int),
                      ((k2 old₀ a'₂ o₀ val₀ a'₃ (CollectionsRingBufferRingBuffer.ring old₀) (CollectionsRingBufferRingBuffer.hd old₀) (CollectionsRingBufferRingBuffer.tl old₀) val₀ o₀ a'₂)) ->
                       ((k3 old₀ val₀ a'₃ True (CollectionsRingBufferRingBuffer.ring old₀) (a'₂ % (collections_sslice_len (t0 := Int) (CollectionsRingBufferRingBuffer.ring old₀))) (CollectionsRingBufferRingBuffer.tl old₀) (CollectionsRingBufferRingBuffer.ring old₀) (CollectionsRingBufferRingBuffer.hd old₀) (CollectionsRingBufferRingBuffer.tl old₀) val₀)))
                     )
                    )
           ) ∧
      (∀ (result₀ : Prop),
                    ...
                    ((collections_sslice_len (t0 := Int) (collections_sslice_set (t0 := Int) (CollectionsRingBufferRingBuffer.ring a'₅) (CollectionsRingBufferRingBuffer.tl a'₅) val₀)) ≥ 0) ->
                     ((collections_sslice_len (t0 := Int) (collections_sslice_set (t0 := Int) (CollectionsRingBufferRingBuffer.ring a'₅) (CollectionsRingBufferRingBuffer.tl a'₅) val₀)) ≤ 18446744073709551615) ->
                      ...
                      (((collections_sslice_len (t0 := Int) (collections_sslice_set (t0 := Int) (CollectionsRingBufferRingBuffer.ring a'₅) (CollectionsRingBufferRingBuffer.tl a'₅) val₀)) ≠ 0) ->
                       ...
                       (((collections_sslice_set (t0 := Int) (CollectionsRingBufferRingBuffer.ring a'₅) (CollectionsRingBufferRingBuffer.tl a'₅) val₀) = (collections_sslice_set (t0 := Int) (CollectionsRingBufferRingBuffer.ring old₀) (CollectionsRingBufferRingBuffer.tl old₀) val₀))) ∧
                       (((a'₆ % (collections_sslice_len (t0 := Int) (collections_sslice_set (t0 := Int) (CollectionsRingBufferRingBuffer.ring a'₅) (CollectionsRingBufferRingBuffer.tl a'₅) val₀))) = (((CollectionsRingBufferRingBuffer.tl old₀) + 1) % (collections_sslice_len (t0 := _) (CollectionsRingBufferRingBuffer.ring old₀))))) ∧
                       (result₀ ->
                        ((CollectionsRingBufferRingBuffer.hd a'₅) = (((CollectionsRingBufferRingBuffer.hd old₀) + 1) % (collections_sslice_len (t0 := _) (CollectionsRingBufferRingBuffer.ring old₀))))) ∧
                       ((¬result₀) ->
