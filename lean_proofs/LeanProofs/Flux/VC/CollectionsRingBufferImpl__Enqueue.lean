...
def CollectionsRingBufferImpl__Enqueue := 
               ...
               ((collections_sslice_len (t0 := Int) (collections_sslice_set (t0 := Int) (CollectionsRingBufferRingBuffer.ring old₀) (CollectionsRingBufferRingBuffer.tl old₀) val₀)) ≥ 0) ->
                ((collections_sslice_len (t0 := Int) (collections_sslice_set (t0 := Int) (CollectionsRingBufferRingBuffer.ring old₀) (CollectionsRingBufferRingBuffer.tl old₀) val₀)) ≤ 18446744073709551615) ->
                 ...
                 (((collections_sslice_len (t0 := Int) (collections_sslice_set (t0 := Int) (CollectionsRingBufferRingBuffer.ring old₀) (CollectionsRingBufferRingBuffer.tl old₀) val₀)) ≠ 0) ->
                  ...
                  (((a'₀ % (collections_sslice_len (t0 := Int) (collections_sslice_set (t0 := Int) (CollectionsRingBufferRingBuffer.ring old₀) (CollectionsRingBufferRingBuffer.tl old₀) val₀))) = (((CollectionsRingBufferRingBuffer.tl old₀) + 1) % (collections_sslice_len (t0 := _) (CollectionsRingBufferRingBuffer.ring old₀))))) ∧
                  (((collections_sslice_set (t0 := Int) (CollectionsRingBufferRingBuffer.ring old₀) (CollectionsRingBufferRingBuffer.tl old₀) val₀) = (collections_sslice_set (t0 := Int) (CollectionsRingBufferRingBuffer.ring old₀) (CollectionsRingBufferRingBuffer.tl old₀) val₀)))
                  )
                  )
                 ) ∧
      ((¬((CollectionsRingBufferRingBuffer.hd old₀) ≠ (((CollectionsRingBufferRingBuffer.tl old₀) + 1) % (collections_sslice_len (t0 := _) (CollectionsRingBufferRingBuffer.ring old₀))))) ->
       ...
       (False ->
        (((CollectionsRingBufferRingBuffer.hd old₀) = (CollectionsRingBufferRingBuffer.hd old₀))) ∧
        (((CollectionsRingBufferRingBuffer.tl old₀) = (((CollectionsRingBufferRingBuffer.tl old₀) + 1) % (collections_sslice_len (t0 := _) (CollectionsRingBufferRingBuffer.ring old₀))))) ∧
        (((CollectionsRingBufferRingBuffer.ring old₀) = (collections_sslice_set (t0 := Int) (CollectionsRingBufferRingBuffer.ring old₀) (CollectionsRingBufferRingBuffer.tl old₀) val₀)))
        )
       )
