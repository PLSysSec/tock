...
namespace CollectionsRingBufferImpl1DequeueKVarSolutions
...
end CollectionsRingBufferImpl1DequeueKVarSolutions
...
def CollectionsRingBufferImpl__1__Dequeue := ∃ k0 : (a0 : (CollectionsRingBufferRingBuffer Int)) -> (a1 : Int) -> (a2 : (Slc Int)) -> (a3 : Int) -> (a4 : Int) -> Prop, ∃ k1 : (a0 : (CollectionsRingBufferRingBuffer Int)) -> (a1 : Int) -> (a2 : Int) -> (a3 : Int) -> (a4 : (Slc Int)) -> (a5 : Int) -> (a6 : Int) -> (a7 : Int) -> (a8 : Int) -> Prop, 
   ...
   ((0 ≤ (CollectionsRingBufferRingBuffer.hd old₀)) ∧ ((CollectionsRingBufferRingBuffer.hd old₀) < (collections_sslice_len (CollectionsRingBufferRingBuffer.ring old₀)))) ->
    ((collections_sslice_len (CollectionsRingBufferRingBuffer.ring old₀)) > 1) ->
     ((¬((CollectionsRingBufferRingBuffer.hd old₀) ≠ (CollectionsRingBufferRingBuffer.tl old₀))) ->
      ...
      (False ->
       ((CollectionsRingBufferRingBuffer.hd old₀) = (((CollectionsRingBufferRingBuffer.hd old₀) + 1) % (collections_sslice_len (CollectionsRingBufferRingBuffer.ring old₀))))) ∧
                 ...
                 ((collections_sslice_len (CollectionsRingBufferRingBuffer.ring old₀)) ≥ 0) ->
                  ((collections_sslice_len (CollectionsRingBufferRingBuffer.ring old₀)) ≤ 18446744073709551615) ->
                   ...
                   (((collections_sslice_len (CollectionsRingBufferRingBuffer.ring old₀)) ≠ 0) ->
                    ...
                    (((a'₂ % (collections_sslice_len (CollectionsRingBufferRingBuffer.ring old₀))) = (((CollectionsRingBufferRingBuffer.hd old₀) + 1) % (collections_sslice_len (CollectionsRingBufferRingBuffer.ring old₀))))) ∧
                    (False ->
                     ((a'₂ % (collections_sslice_len (CollectionsRingBufferRingBuffer.ring old₀))) = (CollectionsRingBufferRingBuffer.hd old₀)))
                    )
                   )
          )
